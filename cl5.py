...
# ===================== تنظیمات =====================
NORMAL_JSON = "normal5.json"
FINAL_JSON = "final5.json"
...
def save_json_files(normal_list: List[Dict], final_list: List[Dict]):
    ...
    print(f"[ℹ️] Normal5 configs: {len(normal_list)} saved to {NORMAL_JSON}")
    print(f"[ℹ️] Final5 configs (after TCP test): {len(final_list)} saved to {FINAL_JSON}")
    print(f"[✅] Update complete.\n  -> Normal5: {len(normal_list)}\n  -> Final5: {len(final_list)}")
...
if __name__ == "__main__":
    print("[*] Starting JSON subscription update for cl5...")
