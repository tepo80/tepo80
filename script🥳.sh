...
# باز کردن لینک در مرورگر اندروید
echo -e "${green}Opening subscription link in browser...${reset}"
am start -a android.intent.action.VIEW -d "$subscription" >/dev/null 2>&1
